...
<div class="row vert-offset-top-3">
    ...
    <div class="col-sm-10" style="margin-left: -12px">
        <div class="col-sm-1">
            <button type="button" class="btn btn-success btn-sm pull-left" ng-click="openNewsPuSMS(1)">News</button>
        </div>
...
<div class="row vert-offset-top-1" ng-init="loadSmsAdvisorymissouri()">
