...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_zd][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('ZD Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_zd][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'ZD Subscriber Report');
        ...
        doLog('[export_excel_zd][NEW][Query is executed ]');
        ...
        doLog('[export_excel_zd][NEW][Excel2007]');

        $fileName = 'ZD_subscriber_report';
        ...
        doLog('[export_excel_zd][Exception][' . $e . ']');
    }
