...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_kn][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('KN Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_kn][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'KN Subscriber Report');
        ...
        doLog('[export_excel_kn][NEW][Query is executed ]');
        ...
        doLog('[export_excel_kn][NEW][Excel2007]');

        $fileName = 'KN_subscriber_report';
        ...
        doLog('[export_excel_kn][Exception][' . $e . ']');
    }
