...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_rm][NEW][sql: ' . $sql . ' ]');
    ...
    doLog('[export_excel_rm][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'RM Subscriber Report');
        ...
        doLog('[export_excel_rm][NEW][Query is executed ]');
        ...
        doLog('[export_excel_rm][NEW][Excel2007]');

        $fileName = 'RM_subscriber_report';
        ...
        doLog('[export_excel_rm][Exception][' . $e . ']');
    }
