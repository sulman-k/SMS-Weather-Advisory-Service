...
//        echo '<br />';
    ...
    private function readSst()
    {
        ...
        for ($i = 0; $i < $nm; ++$i) {
            ...
            // bit: 2; mask: 0x02; 0 = ordinary; 1 = NorthAmerican phonetic
            $hasNorthAmerican = (($optionFlags & 0x04) != 0);
            ...
            if ($hasNorthAmerican) {
                // size of NorthAmerican phonetic setting
            ...
            // read additional NorthAmerican phonetics information, if any
            if ($hasNorthAmerican) {
                // For NorthAmerican phonetic settings, we skip the extended string data
...
//        echo '<br />';
     ...
     * OpenOffice documentation: 2.5.3
     * this function is under construction, needs to support rich text, and NorthAmerican phonetic settings
     *
     * @param string $subData
     * @return array
     */
    ...
    private static function readUnicodeString($subData, $characterCount)
    {
        ...
        // bit: 2; mask: 0x04; NorthAmerican phonetic settings
        $hasNorthAmerican = (0x04) & ord($subData[0]) >> 2;

        // bit: 3; mask: 0x08; Rich-Text settings
        $hasRichText = (0x08) & ord($subData[0]) >> 3;

        // offset: 1: size: var; character array
        // this offset assumes richtext and NorthAmerican phonetic settings are off which is generally wrong
        // needs to be fixed
