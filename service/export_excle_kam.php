...
if (isset($userid) && in_array($role, $cro)) {
    ...
    $objSheet->setTitle('KA rose Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_kam][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'kamsss Subscriber Report');
        ...
        $fileName = 'KAM_subscriber_report';
