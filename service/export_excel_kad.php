...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_kad][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_kad][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('K-AMDANI Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_kad][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K-Amdani Subscriber Report');
        ...
        doLog('[export_excel_kad][NEW][Query is executed ]');
        ...
        doLog('[export_excel_kad][NEW][Excel2007]');

        $fileName = 'KAD_subscriber_report';
        ...
        doLog('[export_excel_kd][Exception][' . $e . ']');
    }
