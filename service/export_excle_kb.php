...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_kb][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_kb][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('watson_Bima Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_kb][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K_BIMA Subscriber Report');
        ...
        doLog('[export_excel_kb][NEW][Query is executed ]');
        ...
        doLog('[export_excel_kb][NEW][Excel2007]');

        $fileName = 'Kbima_subscriber_report';
