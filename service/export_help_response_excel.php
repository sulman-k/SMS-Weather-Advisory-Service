...
if (isset($userid) && in_array($role, $cro)) {
    ...
    $sql = "SELECT cellno,state,create_dt FROM help_requests WHERE ".$state." status = 100  ".$condition." ORDER BY response_dt desc";
    ...
    try {
        ...
        $objSheet->setCellValue('C4', 'RESPONSE DATE/TIME');
