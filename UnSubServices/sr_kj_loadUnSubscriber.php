...

{
    ...
    doLog('[sr_kj_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $kj_conn->query($sql_total);
    ...
    doLog('[sr_kj_loadUnSubscribers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for K_guard  Unsubscriber";
    }
