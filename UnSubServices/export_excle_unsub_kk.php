...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_kk][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_kk][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('K_william UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kk][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K_william unSubscriber Report');
        ...
        doLog('[export_excel_unsub_kk][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_kk][NEW][Excel2007]');

        $fileName = 'K-william_unsubscriber_report';
        ...
        doLog('[export_excel_unsub_kk][Exception][' . $e . ']');
    }
