...

{
    ...
    doLog('[sr_rm_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    ...
    doLog('[sr_rm_loadUnSubscribers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for RM  Unsubscriber";
    }
