...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_kn][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_kn][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('KN UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kn][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'KN unSubscriber Report');
        ...
        doLog('[export_excel_unsub_kn][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_kn][NEW][Excel2007]');

        $fileName = 'KN unsubscriber_report';
        ...
        doLog('[export_excel_unsub_kn][Exception][' . $e . ']');
    }
