...

{
    ...
    doLog('[sr_wdc_loadSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $wdc_conn->query($sql_total);
    ...
    doLog('[sr_wdc_loadunSubscribers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for web doc  Unsubscriber";
    }
