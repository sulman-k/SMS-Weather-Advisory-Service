...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_wdc][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_wdc][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('WEB DOC unSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_wdc][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        doLog('[export_excel_wdc][NEW][Query is executed ]');
        ...
        doLog('[export_excel_wdc][NEW][Excel2007]');

        $fileName = 'WEB DOC unSubscriber Report';
        ...
        doLog('[export_excel_wdc][Exception][' . $e . ']');
    }
