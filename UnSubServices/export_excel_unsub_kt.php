...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_kt][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_kt][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('K-Tahafuz UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kt][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K-Tahafuz unSubscriber Report');
        ...
        doLog('[export_excel_unsub_kt][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_kt][NEW][Excel2007]');

        $fileName = 'K-Tahafuz unsubscriber_report';
        ...
        doLog('[export_excel_unsub_kt][Exception][' . $e . ']');
    }
