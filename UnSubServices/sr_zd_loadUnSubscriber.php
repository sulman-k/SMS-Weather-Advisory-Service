...

{
    ...
    doLog('[sr_zd_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    ...
    doLog('[sr_zd_loadUnSubscribsers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for Z_Directory  Unsubscriber";
    }
