...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_kj][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_kj][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('K_Jeewan UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kj][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K_Jeewan unSubscriber Report');
        ...
        doLog('[export_excel_unsub_kj][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_kj][NEW][Excel2007]');

        $fileName = 'K-Jeewan_unsubscriber_report';
        ...
        doLog('[export_excel_unsub_kj][Exception][' . $e . ']');
    }
