...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_rm][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_rm][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('RM UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_rm][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'RM unSubscriber Report');
        ...
        doLog('[export_excel_unsub_rm][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_rm][NEW][Excel2007]');

        $fileName = 'RM unsubscriber_report';
        ...
        doLog('[export_excel_unsub_rm][Exception][' . $e . ']');
    }
