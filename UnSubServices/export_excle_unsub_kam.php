...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_kam][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('KA_rose Subscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kam][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'KAM unSubscriber Report');
        ...
        doLog('[export_excel_kam][NEW][Query is executed ]');
        ...
        doLog('[export_excel_kam][NEW][Excel2007]');

        $fileName = 'KAM_unsubscriber_report';
        ...
        doLog('[export_excel_kam][Exception][' . $e . ']');
    }
