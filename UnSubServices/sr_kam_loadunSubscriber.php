...

{
    ...
    doLog('[sr_kam_loadSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $km_conn->query($sql_total);
    ...
    doLog('[sr_kam_loadunSubscribers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for K_Muweshi Unsubscriber";
    }
