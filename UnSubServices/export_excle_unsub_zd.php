...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_zd][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_zd][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('ZD UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_zd][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'ZD unSubscriber Report');
        ...
        doLog('[export_excel_unsub_zd][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_zd][NEW][Excel2007]');

        $fileName = 'ZD unsubscriber_report';
        ...
        doLog('[export_excel_unsub_zd][Exception][' . $e . ']');
    }
