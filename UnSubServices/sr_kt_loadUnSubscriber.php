...

{
    ...
    doLog('[sr_kt_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $kt_conn->query($sql_total);
    ...
    doLog('[sr_kt_loadUnSubscribsers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for K_Tahafuz  Unsubscriber";
    }
