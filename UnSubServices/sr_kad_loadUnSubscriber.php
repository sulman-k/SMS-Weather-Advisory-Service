...

{
    ...
    doLog('[sr_kad_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $kad_conn->query($sql_total);
    ...
    doLog('[sr_kad_loadUnSubscribsers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for K_Amdani  Unsubscriber";
    }
