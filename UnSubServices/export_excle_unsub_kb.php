...
if (isset($userid) && in_array($role, $cro)) {
    ...
    doLog('[export_excel_unsub_kb][NEW][start date: ' . $st . ' ][NEW][end date: ' . $end . ' ] [NEW][cellno: ' . $cellno . ' ][is date : '. $is_dt . ']');
    ...
    doLog('[export_excel_unsub_kb][NEW][sql: ' . $sql . ' ]');
    ...
    $objSheet->setTitle('K_Bima UNSubscriber Report');
    $rowCount = 1;
    $objSheet->getColumnDimension('A')->setAutoSize(true);

    doLog('[export_excel_unsub_kb][NEW][sql: Excel obj is created ]');
    ...
    try {
        ...
        $objSheet->setCellValue('A1', 'K_BIMA unSubscriber Report');
        ...
        doLog('[export_excel_unsub_kb][NEW][Query is executed ]');
        ...
        doLog('[export_excel_unsub_kb][NEW][Excel2007]');

        $fileName = 'K BIMA_unsubscriber_report';
        ...
        doLog('[export_excel_unsub_kb][Exception][' . $e . ']');
    }
