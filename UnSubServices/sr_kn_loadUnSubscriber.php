...

{
    ...
    doLog('[sr_kn_loadUnSubscribers][] [sql_total: ' . $sql_total . '][dt chck:' . $date_check . ']');
    $result = $kn_conn->query($sql_total);
    ...
    doLog('[sr_kn_loadUnSubscribers][] [sql: ' . $sql . ']');
    ...
    if ($result->num_rows>0) {
        ...
        $response["msg"] = "No record found for KN  Unsubscriber";
    }
